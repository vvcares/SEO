...
$auth_users = array(
    'Admin1' => '$2y$10$TNSN3YB6/7NVq84Qe0QtI.yre0Dvx6zpKmxtH2AAEKi0KPlxOFnYa', //admin
    //'user' => '$2y$10$Fg6Dz8oH9fPoZ2' //12345
);
...
$default_timezone = '+8'; // UTC
// Root path for file manager
$root_path = $_SERVER['DOCUMENT_ROOT'].'/w/gallery/images/gallery';
// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = 'w/gallery2/images/gallery';
...
$upload_extensions = 'jpg,png,jpeg'; // 'gif,png,jpg'
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="text-center">
            <form class="form-signin" action="" method="post" autocomplete="off">
                <img class="mb-4" src="https://vvcares.com/logo.png" alt="VVCares H3K file Manager">
...
{
    return array(
        'txt', 'css', 'ini', 'conf', 'log', 'passwd', 'ftpquota', 'sql', 'js', 'json', 'sh', 'config',
...
<head>
    ...
    <title>VVCares H3K Web File Manager</title>
